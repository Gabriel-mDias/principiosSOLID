...
public class CarrinhoCRP {
    ...
    public void addProdutos(Produto p){
        ...
        //Dessa forma, sem utilizar herança, com cada desconto sendo um componente, está sendo aplicado o princípio de reuso por composição
