 ...
 * @author gabriel
 */
public class PrincipioReusoPorComposicaoTest {
    ...
    public void CT01(){
        ...
        c.addProdutos(p1);
        c.addProdutos(p2);
        c.addDesconto(new Desconto(new DescontoTipo()));
        c.addDesconto(new Desconto(new DescontoLiquidacao()));
        
        FecharPedidoCRP fp = new FecharPedidoCRP(c);
